...
class ReservedTest:
    ...
    def register_user(self):
        ...
        account_menu = driver.find_element_by_xpath(
            '//*[@id="headerWrapper"]/div/div[2]/button[1]')
        action.move_to_element(account_menu).perform()

        register_button = driver.find_element_by_xpath(
            '//*[@id="headerWrapper"]/div/div[2]/div[2]/section[2]/a')
        ...
        driver.find_element_by_xpath(
            '//*[@id="loginRegisterRoot"]/div/div[2]/div/form/button').click()

    def login_user(self):
        driver = self.driver
        action = ActionChains(driver)
        driver.get("https://www.reserved.com/")
        store_poland_button = driver.find_element_by_link_text(
            'Polska / Poland')
        ...
        driver.find_element_by_xpath(
            '//*[@id="headerWrapper"]/div/div[2]/div[2]/section[1]/a').click()

        driver.find_element_by_id("login[username]_id").send_keys(self.email)
        driver.find_element_by_id(
            "login[password]_id").send_keys(self.password)
        driver.find_element_by_xpath(
            '//*[@id="loginRegisterRoot"]/div/div[1]/div/form/button').click()
    ...
    def logout_user(self):
        ...
        logout_button = driver.find_element_by_xpath(
            '//*[@id="headerWrapper"]/div/div[2]/div[2]/section[1]/div/a')
        logout_button.click()
...
class MediaMarkt:
    ...
    def cart_is_empty_at_start(self):
        ...
        driver.find_element_by_xpath(
            '//*[@id="js-m-quickCartInfo"]/div/a').click()
        empty_cart_text = driver.find_element_by_xpath(
            '//*[@id="js-cart-list-content"]/div/section/div/div[1]').text
    ...
    def can_back_from_empty_cart(self):
        ...
        driver.find_element_by_xpath(
            '//*[@id="js-cart-list-content"]/div/section/div/div[2]/a').click()
...
for d in drivers:
    email = "tautestemail" + str(int(randrange(5000))) + "@gmail.com"
    re = ReservedTest('lukasz', 'reinke', email, '!Test12345!', d)
    try:
